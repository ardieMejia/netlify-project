...
<html lang="en"> 
    ...
    <body>
            ...
            <ul>
                ...
                <li class="sub-menu-parent" tab-index="0">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="./sm/sm_pdfs_books.html">Links</a></li>
        ...
        <h1>My Woodworking Projects 2020</h1>
<div class="row">
<div class="column">
        <div class="card">
...
<div class="column">
    <div class="card">
        ...
        <div class="container">
            <h4><b>My first wooden plane</b></h4> 
            <p>
        ...
        <div class="img-container">
            <img src="./images/fixing-old-plane.jpg" alt="tenon saw" style="width:50%">
        </div>
    </div>
</div>
